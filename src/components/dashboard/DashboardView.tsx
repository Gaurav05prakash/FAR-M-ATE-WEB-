...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  const bannerT = DASHBOARD_BANNER_TRANSLATIONS[language] || DASHBOARD_BANNER_TRANSLATIONS.en;
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              >
                ...
                <span>{bannerT.verifyInputs}</span>
              </button>
              <button
              ...
              >
                ...
                <span>{bannerT.scanLeafDisease}</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch">
          ...
          <div className="lg:col-span-4 bg-white border border-neutral-200 rounded-2xl p-5 sm:p-6 shadow-xs flex flex-col justify-between">
            <form onSubmit={handleSubmitQuickPestQuestion} className="space-y-3.5">
              ...
              <div>
                ...
                >
                  {PRESET_CROPS.map((crop) => (
                    <option key={crop.key} value={crop.en}>
                      {crop.translations[language] || crop.en}
                    </option>
                  ))}
                </select>
              </div>
              ...
              <div>
                ...
                >
                  {PRESET_SOIL_TYPES.map((soil) => (
                    <option key={soil.key} value={soil.en}>
                      {soil.translations[language] || soil.en}
                    </option>
                  ))}
                </select>
              </div>
              ...
              <div>
                <label className="block text-[11px] font-bold text-neutral-700 mb-1">
                  {bannerT.askSymptomsOrQuestion}
                </label>
                <textarea
                  rows={2}
                  value={quickQuestion}
                  onChange={(e) => setQuickQuestion(e.target.value)}
                  placeholder={bannerT.questionPlaceholder}
              ...
              <div className="pt-2">
                ...
                >
                  <Bug className="w-4 h-4" />
                  <span>{bannerT.askPestDoctorBtn}</span>
